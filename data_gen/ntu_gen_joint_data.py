...
training_subjects = list(range(1,105))  # [1, 2, 4, 5, 8, 9, 13, 14, 15, 16, 17, 18, 19, 25, 27, 28, 31, 34, 35, 38]
...
def read_skeleton_filter(file):
    with open(file, 'r') as f:
        ...
        for t in range(skeleton_sequence['numFrame']):
            ...
            for m in [0]:  # range(frame_info['numBody']):
                body_info = {}
                body_info_key = [
...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xsub', part='eval'):
